...
var completedTasksHolder=document.getElementById("complete-list");//complete-list
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className='item__check-box'
    editInput.type="text";
    editInput.className="task";
    editInput.classList.add("item__task-input");///////////////////////////
...
var taskCompleted=function(){
    ...
    //Append the task list item to the #complete-list
    var listItem=this.parentNode;
